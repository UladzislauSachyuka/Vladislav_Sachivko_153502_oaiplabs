...
std::string MainWindow::strToStd(std::string input)
{
    std::string temp;
...
std::string MainWindow::StdTostr(std::string input)
{
...
std::string MainWindow::QStrTostr(QString input)
{
    std::string temp;
...
QString MainWindow::strToQStr(std::string input)
{
    QString temp;
...
{
    QString path = QFileDialog::getOpenFileName(this, "choose file", "C:\\Qt\\Labs\\Lab4_Parser\\file.txt");
...
void MainWindow::on_classButton_clicked()
{
    ...
    QList<std::string> className, classType, arrayName;
    QList<int> classCounter, arrayCount;
...
{
    QList<std::string> name;
    QList<int> count, localOn, localOff, index;
...
void MainWindow::on_deppButton_clicked()
{
    ...
    int bracket = 0;
    QList<std::string> name;
    QList<int> localOnTemp, localOffTemp, deep;
    ...
    QList<QString> tmp = ui->plainTextEdit->toPlainText().split('\n');
    QList<QString> text;
